package com.soochang.presentation.ui.openapi.naverbooks.detail
...
import com.soochang.presentation.databinding.FragmentNaverBookDetailBinding
...
@AndroidEntryPoint
class NaverBookDetailFragment : BaseFragment<FragmentNaverBookDetailBinding>(FragmentNaverBookDetailBinding::inflate) {
    private val viewModel: NaverBookDetailViewModel by viewModels()

    private val args: NaverBookDetailFragmentArgs by navArgs()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        Log.d(TAG, "onCreate: args.isbn ${args.id}")
    }
            ...
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                ...
                launch {
                    viewModel.eventFlow.collectLatest { event ->
                        when(event) {
                            is NaverBookDetailViewModel.UiEvent.ShowErrorSnackbar -> {
