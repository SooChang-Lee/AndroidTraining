...
@HiltViewModel
class SharedElementTransitionDetailViewModel @Inject constructor(
    ...
    fun getBookDetail(id: String?) {
        ...
        viewModelScope.launch {
            val result: Result<BookItem> = getBookDetailUseCase(OpenApiRepository.BookDataSource.KakaoBooks, id)
