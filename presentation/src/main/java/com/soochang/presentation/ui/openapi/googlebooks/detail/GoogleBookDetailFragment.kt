package com.soochang.presentation.ui.openapi.googlebooks.detail
...
import com.soochang.presentation.databinding.FragmentGoogleBookDetailBinding
...
@AndroidEntryPoint
class GoogleBookDetailFragment : BaseFragment<FragmentGoogleBookDetailBinding>(FragmentGoogleBookDetailBinding::inflate) {
    private val viewModel: GoogleBookDetailViewModel by viewModels()

    private val args: GoogleBookDetailFragmentArgs by navArgs()
            ...
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                ...
                launch {
                    viewModel.eventFlow.collectLatest { event ->
                        when(event) {
                            is GoogleBookDetailViewModel.UiEvent.ShowErrorSnackbar -> {
